...
# run Data.manip, run analysis, and run Data.manip again
...
#### we should be able to stick this in data.manip at line 24, and it would work like a charm #####
...
# the data is gross, so you have to enter the movie's date of release as well
...
#get the movie id from movie name by looping through user0movielist
i <- 1
for (i in 1:5) {
...
#### the above could go into data.manip at line 24 and work like a charm ####
